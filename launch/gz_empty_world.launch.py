...
# ================== ENVIRONMENT SETUP =================== #
    ...
    robot_description_path = get_package_share_directory('carpet_rover_description')  # -----> Change me!
    robot_package = FindPackageShare('carpet_rover_description') # -----> Change me!
    robot_name = 'carpet_rover' # Verify this matches your robot's actual spawned name/tf_prefix
    robot_urdf_file_name = 'robot.urdf.xacro'
    rviz_config_file_name = 'carpet_rover_config1.rviz'
...
# ======================== RVIZ ========================== #
    ...
    # Joint State Publisher GUI node - only uncomment if running RVIZ with no Gazebo plugins
...
# ================= GAZEBO BRIDGES & SENSOR SETUP =================== #
    ...
    #THESE ARE SPECIFIC TO GETTING THE USING LIDAR ON GAZEBO:
